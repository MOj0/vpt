...
export class RenderingContext extends EventTarget {
    ...
    initGL() {
        ...
        this.renderDurationSum = 0;
        this.renderCounts = 0;
        this.maxRenderCounts = 1000;
    }
    ...
    render() {
        ...
        if (this.renderCounts < this.maxRenderCounts) {
            const start = performance.now();
            this.renderer.render();
            const end = performance.now();
            this.renderDurationSum += end - start;
            this.renderCounts++;
        } else {
            console.log("Average render time: " + this.renderDurationSum / this.maxRenderCounts, "ms");
            this.renderCounts = 0;
            this.renderDurationSum = 0;
        }
